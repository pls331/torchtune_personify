...
_ALL_RECIPES = [
    Recipe(
        ...
        configs=[
            ...
            Config(
                name="personify/personify_1B_full_single_device",
                file_path="personify/personify_1B_full_single_device.yaml",
            ),
            Config(
                name="personify/personify_8B_full_single_device",
                file_path="personify/personify_8B_full_single_device.yaml",
            ),
            Config(
                name="personify/personify_generation_v2",
                file_path="personify/personify_generation_v2.yaml",
            ),
            Config(
